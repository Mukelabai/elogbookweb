...
public partial class Controls_Reports_PivotSummary : System.Web.UI.Page
{
    ...
    private void BindPivotTotals()
    {
        ...
        field10.SummaryType = GetSummaryType();
        field10.CellFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
        field10.CellFormat.FormatString = "#.#";
        field10.ValueFormat.FormatString = "#.#";
        field10.ValueFormat.FormatType = DevExpress.Utils.FormatType.Numeric;

        //fieldAmountPaid.SummaryType = GetSummaryType();
        //fieldAmountPaid.CellFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
        //fieldAmountPaid.CellFormat.FormatString = "#.#";
        //fieldAmountPaid.ValueFormat.FormatString = "#.#";
        //fieldAmountPaid.ValueFormat.FormatType = DevExpress.Utils.FormatType.Numeric;

        //fieldBalancePayable.SummaryType = GetSummaryType();
        //fieldBalancePayable.CellFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
        //fieldBalancePayable.CellFormat.FormatString = "#.#";
        //fieldBalancePayable.ValueFormat.FormatString = "#.#";
        //fieldBalancePayable.ValueFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
    }
