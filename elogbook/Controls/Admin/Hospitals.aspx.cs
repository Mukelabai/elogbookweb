...
public partial class Controls_Admin_Hospitals : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                bool show = Utility.UserIsAllowedTo("Manage Hospitals", userRights);
                Utility.ShowEditControls(gvHospitals, "colCMDHospitals", show, show, show);
