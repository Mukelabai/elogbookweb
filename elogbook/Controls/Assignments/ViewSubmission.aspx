<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeFile="ViewSubmission.aspx.cs" Inherits="Controls_Assignments_ViewSubmission" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="LeftPanelContent" Runat="Server">
    ...
    <div style="padding:5px">
        <dx:ASPxButton ID="btnComment" runat="server" Text="Comment" Width="100%" OnClick="btnComment_Click"></dx:ASPxButton>
    </div>
    <div style="padding:5px">
        <dx:ASPxRadioButtonList ID="rblStatus" runat="server" ValueType="System.String" RepeatDirection="Horizontal" Width="100%">
            <Items>
                <dx:ListEditItem Text="Approve Submission" Value="Approved" />
                <dx:ListEditItem Text="Request Revision" Value="Revise" />
            </Items>
            <Border BorderStyle="None" />
        </dx:ASPxRadioButtonList>
    </div>
    ...
    <div>
        <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Grade this submission"></dx:ASPxLabel>
    </div>
    <div style="padding:5px">
        <dx:ASPxRadioButtonList ID="rblGrade" runat="server" ValueType="System.Int32" Width="100%" AutoPostBack="True" DataSourceID="sqlDSGrades" OnValueChanged="rblGrade_ValueChanged" TextField="GradeName" ValueField="GradeId">
           
            <Border BorderStyle="None" />
        </dx:ASPxRadioButtonList>
        <asp:SqlDataSource ID="sqlDSGrades" runat="server" ConnectionString="<%$ ConnectionStrings:ApplicationServices %>" SelectCommand="spGT_ElogbookAssignmentGradesLoadAll" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
    </div>
    <div style="padding:5px">
        <hr />
    </div>
...
<asp:Content ID="Content5" ContentPlaceHolderID="PageContent" Runat="Server">
    <dx:ASPxTabControl ID="SchoolsTabControl" runat="server" Width="100%" TabAlign="Justify" Paddings-Padding="0">
        <Tabs>
            <dx:Tab Text="View Submission from " NavigateUrl="#"></dx:Tab>
    ...
    <div style="padding:5px">
                        <dx:ASPxLabel ID="lblSubmission" runat="server" EncodeHtml="true" Font-Bold="True"></dx:ASPxLabel>
                    </div>
    <div style="padding:5px">
                        <dx:ASPxLabel ID="lblMentor" runat="server" Font-Italic="True" ></dx:ASPxLabel>
                    </div>
    <div style="padding:5px"></div>
                    <div style="padding:5px">
                        <dx:ASPxComboBox ID="ddlSubmission" runat="server" Width="100%" TextField="SubmissionName" Visible="false" ValueField="SubmissionId" ValueType="System.Int32" DataSourceID="sqlDSSubmissionsDDL" AutoPostBack="true" OnValueChanged="ddlSubmission_ValueChanged"></dx:ASPxComboBox>
    ...
    <div style="padding-bottom:5px"></div>
                    <div style="padding:5px">
                        <dx:ASPxButton ID="btnAddCase" runat="server" Text="Add a Case" OnClick="btnAddCase_Click" Visible="false"></dx:ASPxButton>
                        <dx:ASPxButton ID="btnAssignmentLevelQuestions" runat="server" Text="View answers to assignment-level questions" OnClick="btnAssignmentLevelQuestions_Click"></dx:ASPxButton>
    ...
    <div>
     ...
     <div>
        ...
        <dx:ASPxRoundPanel ID="rpCase" runat="server" ShowCollapseButton="true" Width="500px" HeaderText="Recorded Case" Visible="false">
            <PanelCollection>
                <dx:PanelContent>                    
                    <div style="padding:5px">
   ...
   <div>
        <dx:ASPxButton ID="btnSaveAssignmentLevelQuestions" runat="server" Text="Save General Questions Data" OnClick="btnSaveAssignmentLevelQuestions_Click" Width="100%" Visible="false"></dx:ASPxButton>
    </div>
     <div>
